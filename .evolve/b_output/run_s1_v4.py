...
S1: 陌生人 — 首次接触 (v4)
修复：
1. session_type=mood（使用 MoodAgent，而非 ChatAgent/WELCOME.md 的 MBTI 引导）
2. 捕获所有 Socket.IO 事件（content_chunk, action_result, tool_call 等）
3. 等待足够时间（每次消息后等 30s）
4. 手动触发记忆写入以验证 P0 路径
"""
...
if __name__ == "__main__":
    ...
    out_path = "/Users/jianghongwei/Documents/moodcoco/.evolve/b_output/S1_raw_v4.json"
